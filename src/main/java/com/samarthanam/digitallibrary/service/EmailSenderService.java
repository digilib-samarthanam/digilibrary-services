...
public class EmailSenderService {
    ...
    public void sendEmailToUser(EmailSenderDto emailSenderDto) {
        ...
        try {
            ...
            log.error("Error reading HTML Template: " + emailSenderDto.getEmailTemplate(), e);
...
//        File file = new File(classLoader.getResource(fileName).getFile());
    ...
    private static InputStream getResourceFileAsInputStream(String fileName) {
        var classLoader = EmailSenderService.class.getClassLoader();
    ...
    private void sendEmailViaSES(String toEmail, String htmlBody, String subject) {
        try {
            var client = AmazonSimpleEmailServiceClientBuilder.standard()
