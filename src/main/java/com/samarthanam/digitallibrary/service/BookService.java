...
public class BookService {
    ...
    public void ReadDataFromExcel() {
        ...
        try {
            S3Object object = amazonS3.getObject(new GetObjectRequest("samarthanam-personal-development", "bulk_upload_books/DigitalLibrary2.xlsx"));
            InputStream objectData = object.getObjectContent();
//            FileInputStream objectData=new FileInputStream("/Users/Z0084MT/Downloads/DigitalLibrary3.xlsx" );
            ...
            if(allDone){
                FileOutputStream out = new FileOutputStream(new File("/Users/Z0084MT/Downloads/DigitalLibraryResult.xlsx"));
                workbook.write(out);
